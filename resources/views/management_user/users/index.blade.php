...
<div class="list-view" style="display: none;">
    ...
    <div class="list-item">
        ...
        <div class="item-details" style="display: none;">
            ...
            <i class="fas fa-eye toggle-password text-primary ms-2" style="cursor:pointer;" data-password="password" data-id="1"></i>
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.data.length) {
                    ...
                    if (response.hasMore) {
                        $('.list-view').append('<button id="load-more" class="btn btn-primary mt-3">Load More</button>');
                    } else {
                        $('#load-more').remove();
                    }
                    loading = false;
