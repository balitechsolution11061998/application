                        ...
                        <div class="row">
                            <div class="col-md-2 mb-4">
                                <div class="card equal-height">
                                    ...
                                    <div class="chart-container text-center">
                                        ...
                                        <span class="chart-number custom-font"
                                            id="student-content">{{ $siswa }}</span>
                                    </div>
                            ...
                            <div class="col-md-2 mb-4">
                                <div class="card equal-height">
                                    ...
                                    <div class="chart-container text-center">
                                        <i class="fas fa-chalkboard icon-animate"
                            ...
                            <div class="col-md-2 mb-4">
                                <div class="card equal-height">
                                    ...
                                    <div class="chart-container text-center">
                                        <i class="fas fa-book-open icon-animate"
                                            style="font-size: 48px; color: #28a745;"></i>
                                        <span class="chart-number custom-font"
                                            id="mata-pelajaran-content">{{ $mapel }}</span>
                                    </div>
                            ...
                            <div class="col-md-2 mb-4">
                                <div class="card equal-height">
                                    ...
                                    <div class="chart-container text-center">
                                        <i class="fas fa-user-plus icon-animate"
                                            style="font-size: 48px; color: #17a2b8;"></i>
                            ...
                            <div class="col-md-2 mb-4">
                                <div class="card equal-height">
                                    ...
                                    <div class="chart-container text-center">
                                        <i class="fas fa-chalkboard-teacher icon-animate"
                                            style="font-size: 48px; color: #e83e8c;"></i>
                            ...
                            <div class="col-md-2 mb-4">
                                <div class="card equal-height">
                                    ...
                                    <div class="chart-container text-center">
                                        <i class="fas fa-calendar-alt icon-animate"
                                            style="font-size: 48px; color: #ffc107;"></i>
                                        <span class="chart-number custom-font"
                                            id="jadwal-content">{{ $jadwal }}</span>
                                    </div>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody id="data-jadwal">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @elseif (date('H:i:s') >= '09:00:00')
                                                    <div
                                                        style="margin-left:20px;width:30px;height:30px;background:#F00">
                                                    </div>
                                                @else
                                                @endif
                                            </td>
                            ...
                            @elseif ($jam <= '07:00')
                                <tr>
                                    <td colspan='5'
                                        style='background:#fff;text-align:center;font-weight:bold;font-size:18px;'>Jam
                                        Pelajaran Hari ini Akan Segera Dimulai!</td>
                                </tr>
                            @elseif (
                                ($hari == '1' && $jam >= '16:15') ||
                                    ($hari == '2' && $jam >= '16:00') ||
                                ...
                                <tr>
                                    <td colspan='5'
                                        style='background:#fff;text-align:center;font-weight:bold;font-size:18px;'>Jam
                                        Pelajaran Hari ini Sudah Selesai!</td>
                                </tr>
