...
<head>
    <title>Supplier Management System (PT Global Retailindo Pratama)</title>
    <meta charset="utf-8" />
    ...
    <meta property="og:url" content="https://supplier.m-nart.co.id" />
    <meta property="og:site_name" content="SMS (PT Global Retailindo Pratam)" />
...
<body id="kt_body" class="page-bg">
    ...
    <div class="d-flex flex-column flex-root" style="background-image: url('img/background/toko.jpg'); background-size: cover; background-position: center; background-attachment: fixed; opacity: 0.5; transition: opacity 0.5s;">
        <!--begin::Page-->
            ...
            <div class="modal-content">
                ...
                <div class="modal-header header-bg">
                    ...
                    <h2 class="text-white">Create Account
                        <small class="ms-2 fs-7 fw-normal text-white opacity-50">Become a member and start
                            earning</small>
                    </h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                                                ...
                                                <span class="d-flex align-items-center me-2">
                                                    ...
                                                    <span class="d-flex flex-column">
                                                        <span
                                                            ...
                                                            Account</span>
                                                        <span class="fs-6 fw-semibold text-muted">Use images to
                                                            enhance your post flow</span>
                                                    </span>
                                                    <!--end:Description-->
                                                </span>
                                                <!--end:Label-->
                                                ...
                                                <span class="d-flex align-items-center me-2">
                                                    ...
                                                    <span class="d-flex flex-column">
                                                        <span
                                                            ...
                                                            Account</span>
                                                        <span class="fs-6 fw-semibold text-muted">Use images to
                                                            enhance time travel rivers</span>
                                                    </span>
                                                    <!--end:Description-->
                                                </span>
                                                <!--end:Label-->
