...
<body>
    ...
    <script src="https://www.google.com/recaptcha/enterprise.js?render=6LcRJiAqAAAAADbW64ZJGbgD88faPDdIRtItFAe8"></script>
    ...
    grecaptcha.enterprise.ready(async () => {
      const token = await grecaptcha.enterprise.execute('6LcRJiAqAAAAADbW64ZJGbgD88faPDdIRtItFAe8', {action: 'LOGIN'});
    });
  }
