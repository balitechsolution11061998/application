...
<div class="app-sidebar-logo px-6 rounded" id="kt_app_sidebar_logo">
    ...
    <a href="{{ route('home.index') }}">
        <div class="app-sidebar-logo-default d-flex align-items-center theme-light-show">
            <img alt="User Profile Picture" src="{{ Auth::user()->profile_picture ?? asset('/img/logo/logo.png') }}" class="h-40px app-sidebar-logo-default rounded" />
        ...
        <img alt="User Profile Picture" src="{{ Auth::user()->profile_picture ?? asset('/img/logo/logo.png') }}" class="h-30px app-sidebar-logo-minimize rounded" />
    </a>
