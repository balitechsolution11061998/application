<x-default-layout>
    ...
    <div class="modal fade modal-lg" id="bulkInputModal" tabindex="-1" aria-labelledby="bulkInputModalLabel" aria-hidden="true">
            ...
            $(function () {
                ...
                const dataTable = $('#dataKependudukanTable').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'tempat_lahir', name: 'tempat_lahir', render: function(data) {
                            return data ? data : '<span class="badge bg-warning"><i class="fas fa-map-marker-alt"></i> No Data</span>';
                        }},
                        { data: 'tanggal_lahir', name: 'tanggal_lahir', render: function(data) {
                            return data ? data : '<span class="badge bg-warning"><i class="fas fa-calendar-times"></i> No Data</span>';
                        }},
                        { data: 'agama', name: 'agama' },
                        { data: 'no_kk', name: 'no_kk' },
                        { data: 'pendidikan', name: 'pendidikan', render: function(data) {
                            return data ? data : '<span class="badge bg-warning"><i class="fas fa-exclamation-circle"></i> No Data</span>';
                        }},
                        { data: 'pekerjaan', name: 'pekerjaan', render: function(data) {
                            return data ? data : '<span class="badge bg-warning"><i class="fas fa-exclamation-circle"></i> No Data</span>';
                        }},
                        { data: 'golongan_darah', name: 'golongan_darah', render: function(data) {
                            return data ? data : '<span class="badge bg-warning"><i class="fas fa-exclamation-circle"></i> No Data</span>';
                        }},
                        { data: 'status_kawin', name: 'status_kawin', render: function(data) {
                            return data ? data : '<span class="badge bg-warning"><i class="fas fa-exclamation-circle"></i> No Data</span>';
                        }},
                        { data: 'nama_ibu', name: 'nama_ibu', render: function(data) {
                            return data ? data : '<span class="badge bg-warning"><i class="fas fa-exclamation-circle"></i> No Data</span>';
                        }},
                        { data: 'nama_bapak', name: 'nama_bapak', render: function(data) {
                            return data ? data : '<span class="badge bg-warning"><i class="fas fa-exclamation-circle"></i> No Data</span>';
                        }},
                        { data: 'alamat', name: 'alamat', render: function(data) {
                            return data ? data : '<span class="badge bg-warning"><i class="fas fa-exclamation-circle"></i> No Data</span>';
                        }},
                        { data: 'ktp_elektronik', name: 'ktp_elektronik', render: function(data) {
                            return data ? '<span class="badge bg-success"><i class="fas fa-check-circle"></i> Yes</span>' : '<span class="badge bg-warning"><i class="fas fa-times-circle"></i> No</span>';
                        }},
