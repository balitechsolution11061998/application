<x-default-layout>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
              <h3 class="card-title">
                  <button type="button" class="btn btn-primary btn-sm" onclick="getCreateKelas()" data-bs-toggle="modal" data-bs-target="#form-kelas">
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('kelas.destroy', $data->id) }}" method="post">
                                @csrf
                                @method('delete')
                                <button type="button" class="btn btn-info btn-sm" onclick="getSubsSiswa({{$data->id}})" data-bs-toggle="modal" data-bs-target=".view-siswa">
                                  <i class="nav-icon fas fa-users"></i> &nbsp; View Siswa
                                </button>
                                <button type="button" class="btn btn-info btn-sm" onclick="getSubsJadwal({{$data->id}})" data-bs-toggle="modal" data-bs-target=".view-jadwal">
                                  <i class="nav-icon fas fa-calendar-alt"></i> &nbsp; View Jadwal
                                </button>
                                <button type="button" class="btn btn-success btn-sm" onclick="getEditKelas({{$data->id}})" data-bs-toggle="modal" data-bs-target="#form-kelas">
    ...
    <!-- Medium modal -->
    <div class="modal fade" id="form-kelas" tabindex="-1" aria-labelledby="formKelasLabel" aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i class='nav-icon fas fa-arrow-left'></i> &nbsp; Kembali</button>
    ...
    <!-- Large modal -->
    <div class="modal fade view-siswa" tabindex="-1" aria-labelledby="viewSiswaLabel" aria-hidden="true">
    ...
    <!-- Extra large modal -->
    <div class="modal fade view-jadwal" tabindex="-1" aria-labelledby="viewJadwalLabel" aria-hidden="true">
    ...
    $('#form_nama').html(`
      ...
      <input type='text' id="name" onkeyup="this.value = this.value.toUpperCase()" name='name' class="form-control @error('name') is-invalid @enderror" placeholder="Nama Kelas">
    `);
    $('#nama_kelas').val('');
    $('#form_paket').html('');
    $('#form_paket').html(`
  ...
  function getEditKelas(id){
    ...
    var form_paket = (`
      ...
      <input type="hidden" id="name_kelas" name="name">
    `);
    $.ajax({
      type:"GET",
      data:"id="+parent,
