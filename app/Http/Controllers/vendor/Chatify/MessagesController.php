...
class MessagesController extends Controller
{
    ...
    public function getContacts(Request $request)
    {
        ...
        // Retrieve all users and left join with messages table to include users with no messages
        ...
        if (count($usersList) > 0) {
            ...
            // If no messages exist, get all users except the authenticated user
