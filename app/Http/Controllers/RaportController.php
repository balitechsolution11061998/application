...
class RaportController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('raport.home', compact('kelas'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('raport.index', compact('kelas', 'siswa'));
    }
    ...
    public function rapot($id)
    {
        ...
        return view('raport.show', compact('mapel', 'siswa', 'kelas'));
    }
    ...
    public function siswa()
    {
        ...
        $kelas = Kelas::findorfail($siswa->kelas_id);
        $pai = MataPelajaran::where('nama_mapel', 'Pendidikan Agama dan Budi Pekerti')->first();
        $ppkn = MataPelajaran::where('nama_mapel', 'Pendidikan Pancasila dan Kewarganegaraan')->first();
