$(document).ready(function() {
  ...
  var table = $('#presence_table').DataTable({
    ...
    columns: [
        ...
        { data: 'user.cabang.name', name: 'user.cabang.name' },
        ...
        },
        {
            ...
            name: 'keterangan',
            render: function(data, type, row) {
                // Check if keterangan is empty and display a custom message
                return data ? data : 'Keterangan is not found';
            }
        }
    ]
});
